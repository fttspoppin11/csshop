...
<div class="wrap">
	...
	<h1 align="center">2018-2학기 과제 제출(민미경 교수님)</h1><!-- 전달사항도 같이 띄움 -->
	<div align="center" >
	<h2>자료구조활용및알고리즘</h2><br/>
	<%
	...
	try{
		String sql = "select * from hw_list where subject='cs1148' and pro_id='mkmin' order by limitdate asc;"; 
