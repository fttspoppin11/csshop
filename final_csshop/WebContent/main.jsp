...
<div class="wrap">
	...
	<div class="menu">
		<a href=# style="position:absolute; top:40px; left:100px; width:100px; height:50px;">과제제출</a>
		<a href=# style="position:absolute; top:40px; left:250px; width:100px; height:50px;">지식IN</a>
		<a href="login.html" style="position:absolute; top:40px; left:400px; width:100px; height:50px;">학생LOGIN</a>
		<a href="pro_login.html" style="position:absolute; top:40px; left:550px; width:100px; height:50px;">교수LOGIN</a>
		<a href="javascript:joinpop()" style="position:absolute; top:40px; left:700px; width:100px; height:50px;">JOIN</a>
	</div>
