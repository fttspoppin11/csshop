...
<div class="wrap">
	...
	<h1 align="center">2018-2학기 과제 제출(곽재창 교수님)</h1><!-- 전달사항도 같이 띄움 -->
	<div align="center" >
	<h2>TCP/IP소켓프로그래밍</h2><br/>
	<%
	...
	try{
		String sql = "select * from hw_list where subject='cs1303' and pro_id='jckwak' order by limitdate asc;"; 
